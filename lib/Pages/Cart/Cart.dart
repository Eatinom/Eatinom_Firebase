...
class CartPage extends State<Cart> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Cart",
            textScaleFactor: 1.0,
            style:
                TextStyle(fontFamily: 'Product Sans', color: Colors.blueGrey)),
        backgroundColor: Colors.white,
        // elevation: 5.0,
        actions: [
          Container(
                        ...
                        child: Center(
                            child: Text('Offers',
                                ...
                                style: TextStyle(
                                    ...
                                    fontSize: 15.0))))),
                IconButton(
                    icon: Image.asset('assets/GiftBox.png',
                        height: 29.0, width: 29.0),
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => CPlist()));
                    })
              ],
            ),
          ),
      ...
      return Stack(
        children: [
          Align(
              ...
              child:
                  Container(child: SingleChildScrollView(child: showList()))),
                                    ...
                                    SizedBox(
                                        width:
                                            MediaQuery.of(context).size.width *
                                                0.72,
                                        child: Text(AppConfig.currentAddress,
                                            maxLines: 3,
                                            textScaleFactor: 1.0,
                                            softWrap: true,
    ...
    try {
      ...
      if (lst.length > 0) {
        ...
        return Container(
            height: 300.0,
            child: Center(
                child: Text('No items are added to the cart',
                    textScaleFactor: 1.0,
                    style: TextStyle(
                        color: Colors.redAccent,
                        fontSize: 18.0,
          ...
          child: Container(
            ...
            child: Row(
                ...
                children: [
                  Container(
                    padding: EdgeInsets.only(
                        top: 0.0, bottom: 0.0, left: 20.0, right: 12.0),
            ...
            child: Row(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Text(
                          '\u20B9 ' +
                              (totalPay * (5 / (100)) / 2).toStringAsFixed(2),
                          textScaleFactor: 1.0,
                          style: TextStyle(
                              color: Colors.blueGrey,
                              fontFamily: 'Product Sans',
  ...
  Widget showCard(CartHolder hld) {
    try {
      ...
      return Stack(children: [
        Container(
            margin:
                EdgeInsets.only(top: 10.0, bottom: 5.0, left: 5.0, right: 5.0),
            decoration: BoxDecoration(
        ...
        Align(
            ...
            child: Container(
                ...
                child: Row(
                    ...
                    children: [
                      _decrementButton(dt),
                      Text(CartData.getItemCount(dt.id).toString(),
                          textScaleFactor: 1.0,
                          style: TextStyle(
                              fontSize: 18.0,
  ...
  Widget PayButton() {
    return Container(
      margin:
          const EdgeInsets.only(left: 20, top: 10, bottom: 20.0, right: 20.0),
      ...
      chefs.forEach((chef) {
        ...
        CartData.cart.values.forEach((hld) {
          if (hld.item['Chef_Id'] == chef && hld.item['Price'] != null) {
            chefPay = chefPay +
                (totalPay * (5 / (100 + 5)) + totalPay - couponAmount).ceil();
        ...
        Orders.add({
          ...
          'Delivery_Location': new GeoPoint(AppConfig.currentPosition.latitude,
              AppConfig.currentPosition.longitude),
          'Chef_Location': new GeoPoint(
              chefDoc['Current_Latitude'], chefDoc['Current_Longitude']),
          'Order_ID': orderID,
          'Otp_ID': otp,
          ...
          if (order != null) {
            ...
            CollectionReference OrdersItems = FirebaseFirestore.instance
                .collection('Order/' + order.id + '/Items');
...
/*
  ...
  void _handleExternalWallet(ExternalWalletResponse response) {
    GlobalActions.showToast_Error(
        'Payment EXTERNAL_WALLET', response.walletName, context);
    setState(() {
      isLoading = false;
    });
  }
