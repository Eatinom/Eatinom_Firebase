...
class GeneralPage extends State<General>{
  ...
  void initState(){
    super.initState();
    FirebaseFirestore.instance.collection('Customer').doc(AppConfig.userID).get().then((value){
      data = value;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("General Profile",textScaleFactor: 1.0, style: TextStyle(fontFamily: 'Product Sans', color: Colors.blueGrey,fontSize: 20.0)),
          backgroundColor: Colors.white,
          //centerTitle: true,
        ),
        body: isLoaded ?  showData() : Container(height: 300.0,child: Center(child: CircularProgressIndicator()))
      ...
      Container(
          child: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              inputBox('First Name', data.data().containsKey('First_Name') ? data['First_Name'] : '' , 'eg. Tony' , ctrlFirstName, _k1),
              inputBox('Last Name', data.data().containsKey('Last_Name') ? data['Last_Name'] : '' , 'eg. Stark' , ctrlLastName, _k2),
              inputBox('Email', data.data().containsKey('Email') ? data['Email'] : '' , 'eg. Tony@gmail.com' , ctrlEmail, _k3),
              inputBox('Phone', data.data().containsKey('Phone_Number') ? data['Phone_Number'] : '' , 'eg. 9999999999' , ctrlPhone, _k4),
              inputBox('D.O.B', data.data().containsKey('DOB') ? data['DOB'] : '' , 'eg. DD/MM/YYYY' , ctrlDOB, _k5),
              ...
              child: Stack(children: [
                ...
                InkWell(
                  child: Container(
                      width: 90.0,
                      height: 100.0,
                      child: Align(alignment: Alignment.bottomCenter,child: Icon(Icons.edit_outlined, size: 20.0,color: Colors.black))
                  ),
                  onTap: (){
                    ShowProfilePics();
                  },
  ...
  Widget ShowProfilePics(){
    try{
      FocusScope.of(context).requestFocus(new FocusNode());
      List<String> pics = ['ProfilePic1.jpg' , 'ProfilePic2.jpg' , 'ProfilePic3.jpg'];
                  ...
                  InkWell(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          shape: BoxShape.circle,
                          boxShadow: [BoxShadow(
                              color: selectedProfilePic == element ? Colors.green : Colors.black26,
                              blurRadius: selectedProfilePic == element ? 5.0 : 1.0
                          )]
                      ),
                      child: CircleAvatar(
                        backgroundColor: Colors.white,
    ...
    return Container(
      ...
      child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: label,
            labelStyle: TextStyle(fontSize: 18.0,color: Colors.blue.shade400, fontFamily: 'Product Sans'),
            errorText: '',
            hintText: hint,
            hintStyle: TextStyle(fontSize: 16.0,color: Colors.blueGrey.shade200, fontFamily: 'Product Sans'),
            filled: true,
          ...
          onTap: () async{
            if(label == 'D.O.B'){
              ...
              if(date != null){
                ctrlDOB.text = date.day.toString()+'/'+date.month.toString()+'/'+date.year.toString();
                this.setState(() {});
              }
            }
          }
    ...
    return Container(
      ...
      child: RaisedButton(
        ...
        child: Container(
          ...
          width: double.infinity,
          child: Text(
            'Save Changes',textScaleFactor: 1.0,
  ...
  bool saveData(){
    try{
      if(ctrlFirstName.text.isEmpty){
        GlobalActions.showToast_Error('First Name Required', 'Please enter your first name', context);
        setState(() {
          isSaving = false;
        });
        return false;
      ...
      if(ctrlLastName.text.isEmpty){
        GlobalActions.showToast_Error('Last Name Required', 'Please enter your first name', context);
        setState(() {
          isSaving = false;
        });
        return false;
      ...
      if(ctrlFirstName.text.isEmpty){
        GlobalActions.showToast_Error('First Name Required', 'Please enter your last name', context);
        setState(() {
          isSaving = false;
        });
        return false;
      ...
      if(ctrlPhone.text.isEmpty){
        GlobalActions.showToast_Error('Phone Number Required', 'Please enter your phone number', context);
        setState(() {
          isSaving = false;
        });
        return false;
      ...
      customer.doc(AppConfig.userID).set({
        ...
        GlobalActions.showToast_Sucess('Success', 'Changes successfully updated to server.', context);
        /*setState(() {
          isSaving = false;
        });*/
