                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                          ...
                                          Align(alignment: Alignment.topRight,
                                              child: Padding(
                                                  ...
                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                                                    Padding(padding: EdgeInsets.only(right: 2.0,bottom: 1.0),child: Icon(Icons.star_rate, size: 13.0,color: Colors.blueGrey)),
                                        ...
                                        const Padding(padding: EdgeInsets.only(top: 3.0,bottom: 2.0)),
                                        Text(
                                          dt['Description'],
                                          maxLines: 2,
                                          overflow: TextOverflow.ellipsis,
                                        ...
                                        '\u20B9 '+dt['Price'].toString(),//dt.data().containsKey('Price') ? dt['Price'] is int ? dt['Price'].toDouble().toString() : dt['Price'].toString() : '-',
                                            ...
                                            style: const TextStyle(
                                              ...
                                              Container(
                                                ...
                                                padding: EdgeInsets.only(left: 10.0,right: 10.0,top: 1.0,bottom: 5.0),
                                                child: Text(dt['ItemCat'],textScaleFactor: 1.0, style: TextStyle(color: Colors.pinkAccent, fontSize: 10.0,fontFamily: 'Product Sans')),
                                              ),
                                              SizedBox(
                                                height: 5,
                                              ),
                                              Text('\u20B9 '+dt['Price'].toString(),//dt.data().containsKey('Price') ? dt['Price'] is int ? dt['Price'].toDouble().toString() : dt['Price'].toString() : '-',
                                                textScaleFactor: 1.0,
                                                style: const TextStyle(
                                                  fontSize: 18.0,
                                              ...
                                              Text('\u20B9 '+dt['DeliveryCharges'].toString(),//dt.data().containsKey('Price') ? dt['Price'] is int ? dt['Price'].toDouble().toString() : dt['Price'].toString() : '-',
                                                textScaleFactor: 1.0,
                                                style: const TextStyle(
                                                  fontSize: 1.0,
                                                  color: Colors.lightGreen,
                                          ...
                                          dt['Order_Type'] == 'Instant' ? CartData.getItemCount(dt.id) > 0 ?
                                          ...
                                          Align(
                                              ...
                                              child: InkWell(child: Container(
                                                  ...
                                                  child: Center(
                                                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                                                        Padding(padding: EdgeInsets.only(bottom: 20.0),child: Icon(Icons.add_circle, size: 20.0,color: Colors.white.withOpacity(0.3))),
                                                        Text('ADD',textScaleFactor: 1.0, style: TextStyle(fontSize: 13.0,fontFamily: 'Product Sans',color: Colors.white))
                                                      ])
                                                  )
                                              ),
                                                onTap: (){
                                          ...
                                          dt['Order_Type'] == 'Pre'  ? CartData.getItemCount(dt.id) > 0 ?
                                          Align(
                                              alignment: Alignment.bottomRight,
                                              child: Container(
                                                  width: 100.0,
