...
class AvailableItems_Widget extends StatefulWidget {
  AvailableItems_Widget({Key key, this.mode}) : super(key: key);
  final String mode;
...
class AvailableItems_WidgetPage extends State<AvailableItems_Widget> {
